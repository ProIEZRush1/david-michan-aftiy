        ...
        <div class="mx-auto max-w-2xl">
            <form @submit.prevent="submit" class="space-y-6 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
                <div>
                    ...
                    <input v-model="form.nombre" type="text" :class="inputClass" placeholder="Línea Plus" />
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    <div>
                        ...
                        <input v-model="form.precio" type="number" step="0.01" min="0" :class="inputClass" placeholder="249" />
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                    <div>
                        ...
                        <input v-model="form.datos" type="text" :class="inputClass" placeholder="8 GB" />
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea v-model="form.descripcion" rows="3" :class="inputClass" placeholder="Beneficios del plan…"></textarea>
                </div>
